...
public class BetterVersionTests
{
    ...
    [InlineData(1, true)]
    [InlineData(2, false)]
    public void Has_MinorVersion_Zero_When_Constructed_With_No_MinorVersions(
        ushort majorVersion,
        bool? supported)
    {
        // Act
    ...
    public void Has_MinorVersion_Zero_And_Given_When_Constructed_With_MinorVersions_Without_Zero(
        ushort majorVersion,
        bool? supported,
    ...
    public void Has_MinorVersion_Given_Versions_When_Constructed_With_MinorVersions_With_Zero(
        ushort majorVersion,
        bool? supported,
        ushort[] minorVersions)
    {
