...
public record BetterVersion
{
    ...
    public IReadOnlyList<ushort> MinorVersions { get; }
    ...
    public BetterVersion(ushort majorVersion, ushort[]? minorVersions = null, bool? supported = true)
    {
        ...
        var normalizedMinorVersions = minorVersions is null
            ? new ushort[] { 0 }
            : [.. new ushort[] { 0 }.Union(minorVersions)];
        MinorVersions = Array.AsReadOnly(normalizedMinorVersions);
    }
